  ...
  if not ((args.fp16 or args.bf16) and custom_kernel_constraint
    ...
    if args.rank == 0:
      ...
      if args.abort_on_unmet_fused_kernel_constraints:
        ...
        print(
            f'WARNING: {error}. We default back to unfused kernel invocations.',
            flush=True)
...
def _initialize_distributed():
  ...
  if torch.distributed.is_initialized():
    ...
    print('> torch distributed is successfully initialized with deepspeed!')
...
def log_restart_to_tensorboard():
  ...
  if writer:
    ...
    writer.add_scalar('iteration-time/world_size', args.world_size,
                      args.iteration)
