...
class DistributedDataParallel(DistributedDataParallelBase):
  ...
  def __init__(self, module, accumulate_allreduce_grads_in_fp32,
    ...
    # print(self.use_contiguous_buffers,self.accumulate_allreduce_grads_in_fp32)
    # print(sg)
    # ===================================
    ...
    if self.use_contiguous_buffers:
      ...
      for param in self.module.parameters():
        ...
        # else:
        #   print('参数不需要梯度',param.shape,param.name)
        #   print(sfg)
  ...
  def allreduce_gradients(self):
    ...
    if self._grad_buffers is not None:
      for _, buffer_ in self._grad_buffers.items():
        ...
        torch.distributed.all_reduce(buffer_.data,
                                     group=mpu.get_data_parallel_group())
    else:
      ...
      for name,param in self.module.named_parameters():
        # print(name,param.shape,param.requires_grad, None if param.grad is None else True)
        # assert param.requires_grad , param.shape
