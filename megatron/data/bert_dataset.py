...
from megatron.data.dataset_utils import (get_samples_mapping,
...
class BertDataset(torch.utils.data.Dataset):
  ...
  def __init__(self, name, indexed_dataset, data_prefix, num_epochs,
               max_num_samples, masked_lm_prob, max_seq_length, short_seq_prob,
               seed, binary_head):
...
def build_training_sample(sample, target_seq_length, max_seq_length,
  ...
  tokens, tokentypes = create_tokens_and_tokentypes(tokens_a, tokens_b, cls_id,
                                                    sep_id)
