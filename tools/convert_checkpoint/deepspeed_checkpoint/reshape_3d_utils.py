...
def flatten_dp_dimension(meg_2d_map, src_2d_size, dp_degree):
  new_meg_2d_map = meg_2d_parallel_map(meg_2d_map.pp_degree,
...
def unflatten_dp_dimension(meg_2d_map, dp_degree):
  ...
  meg_2d_map_list = [
      meg_2d_parallel_map(pp_degree=pp_degree, tp_degree=tp_degree)
