#!/usr/bin/env python
# NOTE: 当前的脚本仅仅在deepspeed 0.8.3测试, 0.6.5不行
...
# 不需要zero files
from tools.convert_checkpoint.deepspeed_checkpoint.deepspeed_checkpoint_wo_zeros import (
    ARGS_KEY, CHECKPOINT_INFO_KEY, DeepSpeedCheckpoint, SEQUENTIAL_LAYERS)

SEQUENTIAL_LAYERS.append('self_attention.query_key_value.lora_A')
