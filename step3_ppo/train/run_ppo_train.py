...
from step3_ppo.train.training_ppo_with_actor_critic import ppo_train
from step3_ppo.models.gpt_model_ppo import ActorCriticModel
...
def ptx_dataset_provider():
  ...
  # remove empty and short-length data
  data = [d for d in data if len(d["input_ids"]) > 10]
