...
from local.rm.last_token.model import GPTModelCritic
...
from local.rm.last_token.reward_inference import generate_reward_model_values
...
def init_flask(port=8050):
  ...
  # app.run('10.10.10.38', port=port, debug=False, threaded=True)
